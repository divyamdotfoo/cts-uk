...
export function FAQs() {
  ...
  return (
    <motion.div className=" bg-slate-100 text-black py-20 ">
      <p className=" text-center pb-14 font-bold text-3xl">
...
function FAQ({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div
      className={cn(
        "bg-white w-full p-4 text-gray-900 text-xl font-medium rounded-lg shadow-sm border hover:border-text-primary transition-all",
        show ? "border-text-primary" : "border-transparent"
      )}
    >
      <button
      ...
      >
        <p className=" text-gray-800 text-base font-light pt-4 tracking-wide">
          {answer}
        </p>
      </motion.div>
    </div>
